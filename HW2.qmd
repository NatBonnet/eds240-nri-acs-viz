...
ggplot(nri_norm, aes(
  ...
  labs(title = "Relative National Risk Index (NRI) and Annual Revenue Loss by U.S. State", 
       ...
       x = NULL, 
       y = NULL, 
       caption = "Data: FEMA Resilience Analysis and Planning Tool (RAPT) National Risk Index (NRI) (2025 Release).", 
       alt = "Radial bar plot dislaying the relative National Risk Index (NRI) by bar height for U.S. states, colored by total expected annual revenue loss with darker colors representing higher annual loss ($0-$30B). California has the highest bar and darkest color.")
```
